...
class RelationClassifier:
	...
	def __init__(self,classifierType='SVM',tfidf=True,features=None,threshold=None,entityCount=2,acceptedEntityTypes=None):
		...
		"""
		assert classifierType in ['SVM','LogisticRegression','DCT', 'NN'], "classifierType must be 'SVM' or 'LogisticRegression'"
	...
	def train(self,corpus):
		...
		# edit add other machine learning tools
		elif self.classifierType == 'DCT':
			self.clf = kindred.MultiLabelClassifier(tree.DecisionTreeClassifier,class_weight='balanced',random_state=1)
		elif self.classifierType == 'NN':
			self.clf = kindred.MultiLabelClassifier(MLPClassifier,solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(5, 2), random_state=1)
