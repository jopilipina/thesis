...
from sklearn import svm, DecisionTreeClassifier
...
class RelationClassifier:
	...
	def __init__(self,classifierType='svm',tfidf=True,features=None,threshold=None,entityCount=2,acceptedEntityTypes=None):
		...
		"""
		assert classifierType in ['svm','LogisticRegression','DCT'], "classifierType must be 'SVM' or 'LogisticRegression'"
	...
	def train(self,corpus):
		...
		# edit add other machine learning tools
			...
			self.clf = kindred.MultiLabelClassifier(DecisionTreeClassifier,class_weight='balanced',random_state=1,max_iter=10000)
